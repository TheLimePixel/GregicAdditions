...
public class GATileEntities {
    ...
    public static void init() {
        ...
        ROCK_BREAKER[0] = GregTechAPI.registerMetaTileEntity(2213, new TileEntityRockBreaker("rock_breaker.lv", GATextures.BREAKER_OVERLAY, 1));
        ROCK_BREAKER[1] = GregTechAPI.registerMetaTileEntity(2214, new TileEntityRockBreaker("rock_breaker.mv", GATextures.BREAKER_OVERLAY, 2));
        ROCK_BREAKER[2] = GregTechAPI.registerMetaTileEntity(2215, new TileEntityRockBreaker("rock_breaker.hv", GATextures.BREAKER_OVERLAY, 3));
        ROCK_BREAKER[3] = GregTechAPI.registerMetaTileEntity(2216, new TileEntityRockBreaker("rock_breaker.ev", GATextures.BREAKER_OVERLAY, 4));
        if (GAConfig.GT5U.highTierRockBreakers) {
            ROCK_BREAKER[4] = GregTechAPI.registerMetaTileEntity(2217, new TileEntityRockBreaker("rock_breaker.iv", GATextures.BREAKER_OVERLAY, 5));
            ROCK_BREAKER[5] = GregTechAPI.registerMetaTileEntity(2218, new TileEntityRockBreaker("rock_breaker.luv", GATextures.BREAKER_OVERLAY, 6));
            ROCK_BREAKER[6] = GregTechAPI.registerMetaTileEntity(2219, new TileEntityRockBreaker("rock_breaker.zpm", GATextures.BREAKER_OVERLAY, 7));
            ROCK_BREAKER[7] = GregTechAPI.registerMetaTileEntity(2220, new TileEntityRockBreaker("rock_breaker.uv", GATextures.BREAKER_OVERLAY, 8));
        }
    }
}
