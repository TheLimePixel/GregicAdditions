...
public class GAMachineRecipeRemoval {
	...
	public static void init() {
		...
		removeRecipesByInputs(RecipeMaps.FORMING_PRESS_RECIPES, MetaItems.CIRCUIT_PARTS_WIRING_ELITE.getStackForm(4), MetaItems.EMPTY_BOARD_ELITE.getStackForm());
		removeRecipesByInputs(RecipeMaps.FORMING_PRESS_RECIPES, MetaItems.CIRCUIT_PARTS_WIRING_ADVANCED.getStackForm(4), MetaItems.EMPTY_BOARD_BASIC.getStackForm());
		removeRecipesByInputs(RecipeMaps.FORMING_PRESS_RECIPES, MetaItems.CIRCUIT_PARTS_WIRING_BASIC.getStackForm(4), MetaItems.EMPTY_BOARD_BASIC.getStackForm());
		removeRecipesByInputs(RecipeMaps.ASSEMBLER_RECIPES, MetaItems.CIRCUIT_PARTS_CRYSTAL_CHIP_ELITE.getStackForm(18), MetaItems.CIRCUIT_ELITE.getStackForm(2));
		removeRecipesByInputs(RecipeMaps.ASSEMBLER_RECIPES, MetaItems.CIRCUIT_PARTS_CRYSTAL_CHIP_MASTER.getStackForm(18), MetaItems.CIRCUIT_MASTER.getStackForm(2));
		...
		for (MaterialStack stack : solderingList) {
			...
			removeRecipesByInputs(RecipeMaps.ASSEMBLER_RECIPES, new ItemStack[] { MetaItems.CIRCUIT_PARTS_CRYSTAL_CHIP_MASTER.getStackForm(3), MetaItems.CIRCUIT_BOARD_ELITE.getStackForm() }, new FluidStack[] { material.getFluid(144 * multiplier) });
			removeRecipesByInputs(RecipeMaps.ASSEMBLER_RECIPES, new ItemStack[] { MetaItems.CIRCUIT_DATA.getStackForm(3), MetaItems.CIRCUIT_BOARD_ELITE.getStackForm() }, new FluidStack[] { material.getFluid(144 * multiplier) });
			removeRecipesByInputs(RecipeMaps.ASSEMBLER_RECIPES, new ItemStack[] { MetaItems.CIRCUIT_BOARD_ADVANCED.getStackForm(), MetaItems.CIRCUIT_PARTS_CRYSTAL_CHIP_ELITE.getStackForm() }, new FluidStack[] { material.getFluid(72 * multiplier) });
			removeRecipesByInputs(RecipeMaps.ASSEMBLER_RECIPES, new ItemStack[] { MetaItems.CIRCUIT_PARTS_ADVANCED.getStackForm(2), MetaItems.CIRCUIT_BOARD_ADVANCED.getStackForm() }, new FluidStack[] { material.getFluid(72 * multiplier) });
			removeRecipesByInputs(RecipeMaps.ASSEMBLER_RECIPES, new ItemStack[] { MetaItems.CIRCUIT_PRIMITIVE.getStackForm(2), MetaItems.CIRCUIT_BASIC.getStackForm() }, new FluidStack[] { material.getFluid(36 * multiplier) });
			removeRecipesByInputs(RecipeMaps.ASSEMBLER_RECIPES, new ItemStack[] { MetaItems.CIRCUIT_PRIMITIVE.getStackForm(2), MetaItems.CIRCUIT_BOARD_BASIC.getStackForm() }, new FluidStack[] { material.getFluid(36 * multiplier) });
			...
			removeRecipesByInputs(RecipeMaps.ASSEMBLER_RECIPES, new ItemStack[] { OreDictUnifier.get(OrePrefix.plate, Materials.Plastic, 2), MetaItems.CIRCUIT_DATA.getStackForm() }, new FluidStack[] { material.getFluid(72 * multiplier) });
		}
