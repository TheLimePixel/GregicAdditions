...
public class MachineCraftingRecipes {
	...
	public static void init() {
		...
		ModHandler.addShapedRecipe("ga_distillation_tower", GATileEntities.DISTILL_TOWER.getStackForm(), "CBC", "FMF", "CBC", 'M', MetaBlocks.MACHINE_CASING.getItemVariant(BlockMachineCasing.MachineCasingType.EV), 'B', new UnificationEntry(OrePrefix.pipeLarge, Materials.StainlessSteel), 'C', new UnificationEntry(OrePrefix.valueOf("circuit"), GAMaterials.EXTREME), 'F', MetaItems.ELECTRIC_PUMP_EV);
		ModHandler.addShapedRecipe("ga_cracker_unit", GATileEntities.CRACKER_UNIT.getStackForm(), "CEC", "PHP", "CEC", 'C', MetaBlocks.WIRE_COIL.getItemVariant(BlockWireCoil.CoilType.CUPRONICKEL), 'E', MetaItems.ELECTRIC_PUMP_HV, 'P', new UnificationEntry(OrePrefix.valueOf("circuit"), Tier.Advanced), 'H', MetaTileEntities.HULL[GTValues.HV].getStackForm());
