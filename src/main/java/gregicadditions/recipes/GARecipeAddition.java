...
public class GARecipeAddition {
    ...
    public static void postInit() {
        ...
        //Pipes
        ModHandler.removeRecipeByName(new ResourceLocation("gregtech:pipe_small_bronze"));
        ModHandler.removeRecipeByName(new ResourceLocation("gregtech:pipe_small_steel"));
        for (Material m : IngotMaterial.MATERIAL_REGISTRY) {
        ...
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(120).EUt(30).notConsumable(IntCircuitIngredient.getIntegratedCircuit(2)).fluidInputs(GAMaterials.Propene.getFluid(2000)).fluidOutputs(Materials.Methane.getFluid(1000), GAMaterials.Isoprene.getFluid(1000)).buildAndRegister();
        ...
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(100).EUt(30).notConsumable(IntCircuitIngredient.getIntegratedCircuit(2)).fluidInputs(Materials.Oxygen.getFluid(2000), GAMaterials.Ethylene.getFluid(1000)).fluidOutputs(GAMaterials.AceticAcid.getFluid(1000)).buildAndRegister();
        ...
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(320).EUt(30).notConsumable(IntCircuitIngredient.getIntegratedCircuit(1)).fluidInputs(Materials.Hydrogen.getFluid(4000), GAMaterials.CarbonMonoxde.getFluid(2000)).fluidOutputs(GAMaterials.AceticAcid.getFluid(1000)).buildAndRegister();
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(480).EUt(30).inputs(OreDictUnifier.get(OrePrefix.dust, Materials.Carbon, 2)).notConsumable(IntCircuitIngredient.getIntegratedCircuit(1)).fluidInputs(Materials.Oxygen.getFluid(2000), Materials.Hydrogen.getFluid(4000)).fluidOutputs(GAMaterials.AceticAcid.getFluid(1000)).buildAndRegister();
        ...
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(320).EUt(30).notConsumable(IntCircuitIngredient.getIntegratedCircuit(1)).fluidInputs(Materials.Oxygen.getFluid(10000), GAMaterials.Ammonia.getFluid(4000)).fluidOutputs(GAMaterials.NitricOxide.getFluid(4000), Materials.Water.getFluid(6000)).buildAndRegister();
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(180).EUt(30).notConsumable(IntCircuitIngredient.getIntegratedCircuit(3)).fluidInputs(Materials.Oxygen.getFluid(1000), GAMaterials.AceticAcid.getFluid(1000), GAMaterials.Ethylene.getFluid(1000)).fluidOutputs(Materials.Water.getFluid(1000), GAMaterials.VinylAcetate.getFluid(1000)).buildAndRegister();
    ...
    public static void postInit2() {
        ...
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(320).EUt(30).notConsumable(IntCircuitIngredient.getIntegratedCircuit(2)).fluidInputs(Materials.Oxygen.getFluid(4000), GAMaterials.Ammonia.getFluid(1000)).fluidOutputs(Materials.NitricAcid.getFluid(1000), Materials.Water.getFluid(1000)).buildAndRegister();
