...
public class GARecipeAddition {
    ...
    public static void postInit() {
        ...
        RecipeMaps.CENTRIFUGE_RECIPES.recipeBuilder().duration(1484).EUt(5).inputs(GAMetaItems.getFilledCell(Materials.LiquidAir.getMaterialFluid(),53)).outputs(GAMetaItems.getFilledCell(Materials.Nitrogen.getMaterialFluid(),40), GAMetaItems.getFilledCell(Materials.Oxygen.getMaterialFluid(),11), GAMetaItems.getFilledCell(Materials.Argon.getMaterialFluid()), GAMetaItems.getFilledCell(Materials.NobleGases.getMaterialFluid())).buildAndRegister();
        RecipeMaps.CENTRIFUGE_RECIPES.recipeBuilder().duration(680).EUt(5).inputs(GAMetaItems.getFilledCell(Materials.NobleGases.getMaterialFluid(),34)).outputs(GAMetaItems.getFilledCell(Materials.CarbonDioxide.getMaterialFluid(),21),GAMetaItems.getFilledCell(Materials.Helium.getMaterialFluid(),9),GAMetaItems.getFilledCell(Materials.Methane.getMaterialFluid(),3),GAMetaItems.getFilledCell(Materials.Deuterium.getMaterialFluid())).buildAndRegister();
