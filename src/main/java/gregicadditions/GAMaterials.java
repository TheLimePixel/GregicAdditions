...
public class GAMaterials {
    ...
    static {
        ...
        VinylChloride = new FluidMaterial(988, "vinyl_chloride", 0xb0bbbb, MaterialIconSet.GAS, ImmutableList.of(new MaterialStack(Materials.Carbon, 2), new MaterialStack(Materials.Hydrogen, 3), new MaterialStack(Materials.Chlorine, 1)), FluidMaterial.MatFlags.STATE_GAS | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
        Ethylene = new FluidMaterial(987, "ethylene", 0xadadad, MaterialIconSet.GAS, ImmutableList.of(new MaterialStack(Materials.Carbon, 2), new MaterialStack(Materials.Hydrogen, 4)), FluidMaterial.MatFlags.STATE_GAS | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
        ...
        Neutronium = new IngotMaterial(972, "neutronium", 0xc3c3c3, MaterialIconSet.METALLIC, 6, ImmutableList.of(), EXT2_METAL | gregtech.api.unification.material.type.IngotMaterial.MatFlags.GENERATE_RING | gregtech.api.unification.material.type.IngotMaterial.MatFlags.GENERATE_ROTOR | gregtech.api.unification.material.type.IngotMaterial.MatFlags.GENERATE_SMALL_GEAR | gregtech.api.unification.material.type.SolidMaterial.MatFlags.GENERATE_LONG_ROD, Element.valueOf("Nt"), 24.0F, 655360);
        ...
        Styrene = new FluidMaterial(957, "styrene", 0xa39c95, MaterialIconSet.FLUID, ImmutableList.of(new MaterialStack(Materials.Carbon, 8), new MaterialStack(Materials.Hydrogen, 8)), FluidMaterial.MatFlags.GENERATE_FLUID_BLOCK | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
        Polystyrene = new IngotMaterial(956, "polystyrene", 0x888079, MaterialIconSet.DULL, 1, ImmutableList.of(new MaterialStack(Materials.Carbon, 8), new MaterialStack(Materials.Hydrogen, 8)), Material.MatFlags.DISABLE_DECOMPOSITION | IngotMaterial.MatFlags.GENERATE_FOIL);
        ...
        RawStyreneButadieneRubber = new DustMaterial(954, "raw_styrene_butadiene_rubber", 0x4f3c3a, MaterialIconSet.SAND, 1, ImmutableList.of(new MaterialStack(Materials.Carbon, 8), new MaterialStack(Materials.Hydrogen, 8), new MaterialStack(GAMaterials.Butadiene, 3)), Material.MatFlags.DISABLE_DECOMPOSITION);
        StyreneButadieneRubber = new IngotMaterial(953, "styrene_butadiene_rubber", 0x1d1715, MaterialIconSet.ROUGH, 1, ImmutableList.of(new MaterialStack(Materials.Carbon, 8), new MaterialStack(Materials.Hydrogen, 8), new MaterialStack(GAMaterials.Butadiene, 3)), DustMaterial.MatFlags.GENERATE_PLATE | SolidMaterial.MatFlags.GENERATE_GEAR | IngotMaterial.MatFlags.GENERATE_RING | Material.MatFlags.FLAMMABLE | DustMaterial.MatFlags.NO_SMASHING | IngotMaterial.MatFlags.GENERATE_FOIL);
        ...
        Tetrafluoroethylene = new FluidMaterial(918, "tetrafluoroethylene", 0x676767, MaterialIconSet.GAS, ImmutableList.of(new MaterialStack(Materials.Carbon, 2), new MaterialStack(Materials.Fluorine, 4)), FluidMaterial.MatFlags.STATE_GAS | Material.MatFlags.DECOMPOSITION_BY_ELECTROLYZING);
        ...
        HydroCrackedEthylene = new FluidMaterial(915, "hydrocracked_ethylene", 0xa3a3a0, MaterialIconSet.GAS, ImmutableList.of(), FluidMaterial.MatFlags.STATE_GAS);
