...
public class GAMaterials {
    ...
    static {
        ...
        SiliconeRubber = new IngotMaterial(960, "silicon_rubber", 0xacacac, MaterialIconSet.DULL, 1, ImmutableList.of(new MaterialStack(Materials.Carbon, 2), new MaterialStack(Materials.Hydrogen, 6), new MaterialStack(Materials.Oxygen, 1), new MaterialStack(Materials.Silicon, 1)), DustMaterial.MatFlags.GENERATE_PLATE | SolidMaterial.MatFlags.GENERATE_GEAR | IngotMaterial.MatFlags.GENERATE_RING | Material.MatFlags.FLAMMABLE | DustMaterial.MatFlags.NO_SMASHING);
        ...
        Polystyrene = new IngotMaterial(956, "polystyrene", 0x888079, MaterialIconSet.DULL, 1, ImmutableList.of(new MaterialStack(Materials.Carbon, 8), new MaterialStack(Materials.Hydrogen, 8)), Material.MatFlags.DISABLE_DECOMPOSITION);
